...
define('DB_USER', 'admin_nilayteamirnaaz2');
define('DB_PASS', 'PtAMrxS9wACcRPkwMXkv');
define('DB_NAME', 'admin_nilayteamirnaaz2');
define('DB_CHARSET', 'utf8mb4');

// --- Application Configuration ---
define('APP_URL', 'https://nilayteam.ir/irnaaz2');
