...
class OrderController extends Controller {
    ...
    public function store() {
        ...
        $data = ['user_id' => (int)$_POST['user_id'], 'title' => $_POST['title'], 'image' => $imageName, 'source_site' => $_POST['source_site'] ?? '', 'quantity' => (int)($_POST['quantity'] ?? 1), 'size' => $_POST['size'] ?? '', 'price_lira' => (float)($_POST['price_lira'] ?? 0), 'price_toman' => (float)$_POST['price_toman'], 'weight' => (float)($_POST['weight'] ?? 0), 'apply_shipping' => isset($_POST['apply_shipping']) ? 1 : 0, 'with_cargo' => isset($_POST['with_cargo']) ? 1 : 0, 'is_store_purchase' => isset($_POST['is_store_purchase']) ? 1 : 0, 'category_id' => !empty($_POST['category_id']) ? (int)$_POST['category_id'] : null, 'description' => $_POST['description'] ?? '', 'status_id' => 1];
    ...
    public function update() {
        ...
        $data = ['user_id' => (int)$_POST['user_id'], 'title' => $_POST['title'], 'image' => $imageName, 'source_site' => $_POST['source_site'] ?? '', 'quantity' => (int)($_POST['quantity'] ?? 1), 'size' => $_POST['size'] ?? '', 'price_lira' => (float)($_POST['price_lira'] ?? 0), 'price_toman' => (float)$_POST['price_toman'], 'weight' => (float)($_POST['weight'] ?? 0), 'apply_shipping' => isset($_POST['apply_shipping']) ? 1 : 0, 'with_cargo' => isset($_POST['with_cargo']) ? 1 : 0, 'is_store_purchase' => isset($_POST['is_store_purchase']) ? 1 : 0, 'category_id' => !empty($_POST['category_id']) ? (int)$_POST['category_id'] : null, 'description' => $_POST['description'] ?? ''];
