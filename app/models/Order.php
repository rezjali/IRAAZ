...
class Order {
    ...
    public function createOrder($data) {
        ...
        $this->db->bind(':source_site', $data['source_site']); 
        $this->db->bind(':quantity', $data['quantity']); 
        $this->db->bind(':size', $data['size']); 
        $this->db->bind(':price_lira', $data['price_lira']); 
        $this->db->bind(':price_toman', $data['price_toman']); 
        $this->db->bind(':weight', $data['weight']); 
        $this->db->bind(':apply_shipping', $data['apply_shipping']); 
        $this->db->bind(':with_cargo', $data['with_cargo']); 
    ...
    public function getOrdersForAssignment() {
        $sql = "SELECT o.*, u.full_name as customer_name 
                ...
                WHERE os.status_category = 'active' 
